const showLoading = (isLoading) => {
  ...
  document.getElementById("loadMore").addEventListener("click", function () {
    ...
    let url = 'https://forbes400.onrender.com/api/forbes400/';
    showPersonData(url);
  });
  
  const showPersonData = (url) => {
    if(url){
        fetch(url)
        .then(res => res.json())
        .then(data => DisplayPersonData(data))
    }
    else{
        fetch('https://forbes400.onrender.com/api/forbes400?limit=6')
        .then(res => res.json())
        .then(data => DisplayPersonData(data))
    }
      const DisplayPersonData = (data) => {
      ...
      <div class="grid grid-cols-2 ">
          ...
          <div class="p-3">
          <h5 class = "md:text-lg font-bold md:text-center border-b-2 border-slate-800 mb-2 ">General Information</h5>
              ...
              <h5 class = "md:text-lg font-bold md:text-center border-b-2 border-slate-800 my-2 ">Financial Information</h5>
